...
package com.example.root.grayson.googleAssistant;
...
public class EmbeddedAssistant {
    ...
    public EmbeddedAssistant(Context context) {
    ...
    // Assistant Thread and Runnable implementing the push-to-talk functionality.
    ...
    public String mGoogleAssistant = "";
            ...
            new StreamObserver<AssistResponse>() {
                ...
                public void onNext(final AssistResponse value) {
                    ...
                    if (value.getDialogStateOut() != null) {
                        ...
                        if (value.getDialogStateOut().getVolumePercentage() != 0) {
                            final int volumePercentage = value.getDialogStateOut()
                                    .getVolumePercentage();
                ...
                public void onCompleted() {
                    ...
                    if (mGoogleAssistant.contains("ok goodbye")
                            ...
                            | mGoogleAssistant.contains("stop conversation")) {
    ...
    private Runnable mStreamAssistantRequest = new Runnable() {
        ...
        public void run() {
            ...
            int result = mAudioRecord.read(audioData, audioData.capacity(),
                    AudioRecord.READ_BLOCKING);  //read blocking
            if (result < 0) {
                return;
            }
            mRequestHandler.post(new Runnable() {
    ...
    public static UserCredentials generateCredentials(Context context, int resourceId)
        ...
        return com.example.root.grayson.googleAssistant.Credentials.fromResource(context, resourceId);
    }
    ...
    public static class Builder {
         ...
         * @return Returns this builder to allow for chaining.
         */
        Builder setRequestCallback(RequestCallback requestCallback,
         ...
         * @return Returns this builder to allow for chaining.
         */
        Builder setConversationCallback(ConversationCallback responseCallback,
    ...
    public static abstract class ConversationCallback {
         ...
         */
        @SuppressWarnings("unused")
        void onAudioSample(ByteBuffer audioSample) {}
     ...
     * Message TO:{@link com.example.root.grayson.GraySonMainActivity}
     */
//------------------------------------------------------------------------------------------------//
    private void sendAction() {
        Log.d("assistant sender", "Broadcasting message");
        Intent intent = new Intent("assistant");
